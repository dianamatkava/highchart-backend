...
function generate_charts() {
    ...
    //DELETE ALL THIS AND SHORTEN USING SET OPTIONS!/////////////////////////////////////////////////////////////

    document.addEventListener('DOMContentLoaded', function () {
        Highcharts.chart('container1G', {
            chart: {
            type: 'pie',
            style: {
                fontFamily: 'Poppins'
            ...
            colors: ['#3b844e', '#6ebd78', '#a1e3a9', '#d1f0d4', '#9d9d9c'],
            legend: {
                layout: 'vertical',
                symbolRadius: 0,
                symbolPadding: 13,
    ...
    document.addEventListener('DOMContentLoaded', function () {
        Highcharts.chart('container6', {
            ...
            xAxis: {
                categories: ['Future Fibres (Pvt)', 'Future Fibres Ringing', 'North Action Sports', 'NTG Europ Ltd', 'NTG Masts Group', 'NTG Masts Group NZ'],
                lineWidth: 0,
                tickWidth: 0,
                labels: {
                    style: {
