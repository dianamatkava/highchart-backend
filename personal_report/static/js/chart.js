  ...
  function generate_gap_subcategories(text, length=null) {let list = []; for (let i=1; i<=10; i++){list.push(text) } return list}
      ...
      Highcharts.chart('container6', {
          ...
          series: [
              {
              name: 'Blank',
              data: generate_remnant('BUSINESS_UNIT'), // data['BU Data']['LEARNERS'].map(function (x) {return Math.max(data['BU Data']['LEARNERS']) + 3 - x }),
              enableMouseTracking: false,
              dataLabels: {
                  enabled: true,
                  formatter: function() {
      ...
      },
      {
              ...
              dataLabels: [{
                  ...
                  y: 2,
                  formatter () {
                      return '<img src="http://40.68.93.242/assets/images/charts/greendot.svg" style="width: 11px">'
                  }
              },
              {
                  enabled: true,
                  ...
                  formatter () {
                      if (this.y==0) {
                          return '<img src="http://40.68.93.242/assets/images/charts/halfdot.svg" style="width: 11px">'
                          }
                      return '<img src="http://40.68.93.242/assets/images/charts/orangedot.svg" style="width: 11px">'
      ...
      Highcharts.chart('container10', {
          ...
          {
              categories: data['MODULE_RATING_&_RELEVANCE']['RATING'],
              linkedTo: 0,
              opposite: true,
              labels: {
              useHTML: true,
          ...
          {
              categories: data['MODULE_RATING_&_RELEVANCE']['RELEVANCE'],
              linkedTo: 0,
              opposite: true,
              labels: {
              useHTML: true,
          ...
          series: [
          {
              ...
              name: 'Module Rating',
              showInLegend: true,
              data: data['MODULE_RATING_&_RELEVANCE']['RATING'].slice(1, data['MODULE_RATING_&_RELEVANCE']['RATING'].length),
              stack: 'moduleRating',
              color: '#2e8b57',
              dataLabels: {
                  enabled: false,
          ...
          },
          {
              ...
              showInLegend: true,
              data: data['MODULE_RATING_&_RELEVANCE']['RELEVANCE'].slice(1, data['MODULE_RATING_&_RELEVANCE']['RELEVANCE'].length),
              stack: 'moduleRelevance',
              color: '#3984bc',
              dataLabels: {
                  enabled: false,
