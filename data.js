...
// go to the bottom to see correct data
data = {
    'Cohort Summary': {
        'Learners Invited': 55, 
        'Learners Activated': 51, 
        'Learners Licensed': 30, 
        'Learners Completed': 37, 
        'Compltion rate': 84, 
        'Certificatoin Rate': 81
        }, 
    'Confidence Summary': {
        'Skills Gain': 0.46, 
        'Confidence Gain': 0.54
        }, 
    'Location data': {
    ...
    'Bu Data': {
        'categories': ['Business Strategy', 'Cons - HQ', 'Cyber & Forensics', 'Deals - BRS', 'Deals - CPI', 'Deals - CPT', 'Deals - FDD', 'Deals VH', 'DS - Admin', 'FCS - HR', 'FCS - L&D', 'Finance Transformation', 'Financial Crime', 'Front Office Transformation', 'Productivity', 'Tax - CTA', 'Tax - CTS', 'Tax - CTS DT', 'Tax - Deals', 'Tax - FS', 'Tax - GS'], 
        'Learners': [1, 1, 3, 3, 1, 1, 4, 2, 1, 1, 2, 2, 2, 2, 1, 1, 3, 2, 1, 2, 1]
        }, 
    'Expertise': {
        'categories': ['Customer Management', 'Finance', 'HR', 'Marketing', 'Other', 'Sales', 'Technical/Engineering'], 
        'Learners': [1, 16, 4, 1, 12, 1, 2], 
    ...
    'Role': {
        'categories': ['Individual Contributor', 'Manager/Team Lead'], 
        'Learners': [3, 34], 
        'Individual Contributor': 3, 
        'Manager/Team Lead': 34
        }, 
    'Gender': {
        'categories': ['Female', 'Male', 'Rather not say'], 
        'Learners': [21, 14, 2], 
        'Female': 21, 
        'Male': 14, 
        'Rather not say': 2
    ...
    'Work Experience': {
        'categories': ['< 5 years', '15 years +', '5 - 10 Years'], 
        'Learners': [6, 1, 30], 
        '< 5 years': 6, 
        '15 years +': 1, 
        '5 - 10 Years': 30
    ...
    'Performance Summary': {
        'categories': ['Cohort Average Score'], 
        'Value': [80],
        'nan': ['nan']
        }, 
    'Module data': {
        'categories': ['Self-Awareness', 'Communication', 'Time Management', 'How to Sell', 'How to Say No', 'Effective Meetings', 'Critical Thinking', 'Planning & Agility', 'Professionalism', 'Collaboration & Teamwork'], 
        'Cohort Average': [0.83, 0.76, 0.75, 0.69, 0.78, 0.75, 0.55, 0.68, 0.69, 0.69], 
        'Global Average': [0.76, 0.74, 0.78, 0.66, 0.72, 0.77, 0.58, 0.69, 0.7, 0.67]
        }, 
    'Certification Level': {
        'categories': ['None', 'Completion', 'Merit', 'Distinction'], 
        'Learners': [7, 5, 20, 5], 
        '%': [19, 14, 54, 14]
        }, 
    'Feedback Summary': {
        'categories': ['Average Course Rating', 'Average Course Relevance'], 
        'Value': [8.23, 8.87], 
        'nan': ['nan', 'nan']
        }, 
    'Module Rating & Relevance': {
        'categories': ['Self-Awareness', 'Communication', 'Time Management', 'How to Sell', 'How to Say No', 'Effective Meetings', 'Critical Thinking', 'Planning & Agility', 'Professionalism', 'Collaboration & Teamwork'], 
        'Rating': [7.92, 8.22, 8.81, 8.08, 8.34, 8.24, 7.62, 8.21, 8.57, 8.47], 
        'Relevance': [8.72, 9.16, 9.08, 8.69, 9.09, 8.85, 8.79, 8.52, 8.96, 8.74]
        }, 
    'Gap to Goal Data': {
        'categories': ['Self Awareness', 'Communication', 'Time Management', 'How to Sell', 'How to Say No', 'Effective Meetings', 'Critical Thinking', 'Planning & Agility', 'Professionalism', 'Collaboration & Teamwork', 'Average'], 
        'Module/Stage': {
            'PRE': {
                'Current': [1, 2, 3, 4, ], 
                'Goal': [1, 2, 3, 4, ], 
        ...
        'Self Awareness': {
            'PRE': {'Current': 3.57, 'Goal': 4.35, 'Gap': 0.78}, 
            'POST': {'Current': 4.11, 'Goal': 4, 'Gap': 0}
            }, 
        'Communication': {
            'PRE': {'Current': 3.24, 'Goal': 4.41, 'Gap': 1.16}, 
            'POST': {'Current': 4.05, 'Goal': 4, 'Gap': 0}
            }, 
        'Time Management': {
            'PRE': {'Current': 3.35, 'Goal': 4.51, 'Gap': 1.16}, 
            'POST': {'Current': 4.03, 'Goal': 4, 'Gap': 0}
            }, 
        'How to Sell': {
            'PRE': {'Current': 2.54, 'Goal': 4, 'Gap': 1.46}, 
            'POST': {'Current': 3.78, 'Goal': 4, 'Gap': 1}
            }, 
        'How to Say No': {
            'PRE': {'Current': 2.68, 'Goal': 4.22, 'Gap': 1.54}, 
            'POST': {'Current': 4.03, 'Goal': 4, 'Gap': 0}
            }, 
        'Effective Meetings': {
            'PRE': {'Current': 3.11, 'Goal': 4.38, 'Gap': 1.27}, 
            'POST': {'Current': 4.03, 'Goal': 4, 'Gap': 0}
            }, 
        'Critical Thinking': {
            'PRE': {'Current': 3.46, 'Goal': 4.38, 'Gap': 0.92}, 
            'POST': {'Current': 4, 'Goal': 4, 'Gap': 0}
            }, 
        'Planning & Agility': {
            'PRE': {'Current': 3.51, 'Goal': 4.49, 'Gap': 0.97}, 
            'POST': {'Current': 4.11, 'Goal': 5, 'Gap': 0}
            }, 
        'Professionalism': {
            'PRE': {'Current': 3.7, 'Goal': 4.54, 'Gap': 0.84}, 
            'POST': {'Current': 4.11, 'Goal': 5, 'Gap': 0}
            }, 
        'Collaboration & Teamwork': {
            'PRE': {'Current': 3.84, 'Goal': 4.59, 'Gap': 0.76}, 
            'POST': {'Current': 4.27, 'Goal': 5, 'Gap': 0}
            }, 
        'Average': {
            'PRE': {'Current': 3.51, 'Goal': 4.49, 'Gap': 0.97}, 
            'POST': {'Current': 4.11, 'Goal': 5, 'Gap': 0}
